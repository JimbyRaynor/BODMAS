...
charPlus = [(6,6,"#90EE90"), (6,8,"#90EE90"), (6,10,"#90EE90"), (6,12,"#90EE90"), (6,14,"#90EE90"), (6,16,"#90EE90"), (8,6,"#90EE90"), (8,16,"#C19153"), (9,11,"#FFFF00"), (10,6,"#90EE90"), (10,11,"#FFFF00"), (10,16,"#90EE90"), (11,9,"#FFFF00"), (11,10,"#FFFF00"), (11,11,"#FFFF00"), (11,12,"#FFFF00"), (11,13,"#FFFF00"), (12,6,"#90EE90"), (12,11,"#FFFF00"), (12,16,"#90EE90"), (13,11,"#FFFF00"), (14,6,"#90EE90"), (14,16,"#90EE90"), (16,6,"#90EE90"), (16,8,"#90EE90"), (16,10,"#90EE90"), (16,12,"#90EE90"), (16,14,"#90EE90"), (16,16,"#90EE90")]
charRedPlus = [(6,6,"#90EE90"), (6,8,"#90EE90"), (6,10,"#90EE90"), (6,12,"#90EE90"), (6,14,"#90EE90"), (6,16,"#90EE90"), (8,6,"#90EE90"), (8,16,"#C19153"), (9,11,"#FF0000"), (10,6,"#90EE90"), (10,11,"#FF0000"), (10,16,"#90EE90"), (11,9,"#FF0000"), (11,10,"#FF0000"), (11,11,"#FF0000"), (11,12,"#FF0000"), (11,13,"#FF0000"), (12,6,"#90EE90"), (12,11,"#FF0000"), (12,16,"#90EE90"), (13,11,"#FF0000"), (14,6,"#90EE90"), (14,16,"#90EE90"), (16,6,"#90EE90"), (16,8,"#90EE90"), (16,10,"#90EE90"), (16,12,"#90EE90"), (16,14,"#90EE90"), (16,16,"#90EE90")]
...
def createplayfield():
   ...
   for x,y,stype in pointsset:
       ...
       if stype == strawberrytype:
           ...
           fruitlist.append(fruit)
       if stype == plustype:
           fruit = LEDlib.LEDobj(canvas1,x*wallsize+8,y*wallsize+DOWNOFFSET,dx = 0,dy = 0,CharPoints=charPlus, pixelsize = 4,typestring = FirstEval)
           fruit.collisionrect =  (24,24,68,68)
           fruit.PointsType = 200
           fruitlist.append(fruit)
       if stype == plusredtype:
           fruit = LEDlib.LEDobj(canvas1,x*wallsize+8,y*wallsize+DOWNOFFSET,dx = 0,dy = 0,CharPoints=charRedPlus, pixelsize = 4,typestring = SecondEval)
           fruit.collisionrect = (24,24,68,68)
           fruit.PointsType = 200
           fruitlist.append(fruit)
       if stype == threetype:
    ...
    for fruit in fruitlist:
       if checkcollisionrect(myship,fruit):
            if fruit.typestring == FirstEval:
               ...
               LEDlib.LEDtextobj(canvas1,x=fruit.x,y=fruit.y,text=displaystring,colour="light green",pixelsize = 4, charwidth=32, multicolour=True, plusorder = ["yellow"], solid = True)
               print(mathstring)
            ...
            if fruit.typestring == SecondEval: 
               if FirstEval == "":
                  ...
                  LEDlib.LEDtextobj(canvas1,x=fruit.x,y=fruit.y,text=displaystring,colour="light green",pixelsize = 4, charwidth=32, multicolour=True, plusorder = ["red"], solid = True)
...
displaymath = LEDlib.LEDtextobj(canvas1,x=240,y=60,text=mathstring,colour="light green",pixelsize = 4, charwidth=32, multicolour=True, plusorder = ["red","yellow"], solid = True)
displaymath2 = LEDlib.LEDtextobj(canvas1,x=210,y=98,text="= ?",colour="light green",pixelsize = 4, charwidth=32, multicolour=True, plusorder = ["red"], solid = True)
displaymath3 = LEDlib.LEDtextobj(canvas1,x=210,y=135,text="= ?",colour="light green",pixelsize = 4, charwidth=32, multicolour=True, plusorder = ["red"], solid = True)
